...
{ {
    { SPELL_MAGE_FIREBALL_RANK_1, SPELL_MAGE_FIREBALL_RANK_3, 50, SPELL_MASTERY_TIER_DIAMOND, 10 },
    { SPELL_MAGE_FLAMESTRIKE_RANK_1, SPELL_MAGE_FLAMESTRIKE_RANK_3, 50, SPELL_MASTERY_TIER_DIAMOND, 10 },
    { SPELL_DRUID_REJUVENATION_RANK_1, SPELL_DRUID_REJUVENATION_RANK_3, 50, SPELL_MASTERY_TIER_DIAMOND, 10 },
    { SPELL_DRUID_REGROWTH_RANK_1, SPELL_DRUID_REGROWTH_RANK_3, 50, SPELL_MASTERY_TIER_DIAMOND, 10 }
} };
