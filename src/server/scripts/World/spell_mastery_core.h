...
enum SpellMasteryConstants : uint32
{
    ...
    SPELL_MAGE_PYROBLAST_RANK_1 = 11366,
    SPELL_MAGE_PYROBLAST_RANK_10 = 33938,
    SPELL_MAGE_FLAMESTRIKE_RANK_1 = 2120,
    SPELL_MAGE_FLAMESTRIKE_RANK_3 = 8422,
    SPELL_MAGE_FROSTBOLT_RANK_1 = 116,
    SPELL_MAGE_ICE_LANCE_RANK_1 = 30455,
    SPELL_MAGE_BLIZZARD_RANK_1 = 10,
    SPELL_MAGE_CONE_OF_COLD_RANK_1 = 120,
    SPELL_MAGE_ARCANE_BLAST_RANK_1 = 30451,
    SPELL_MAGE_ARCANE_MISSILES_RANK_1 = 5143,
    SPELL_MAGE_ARCANE_BARRAGE_RANK_1 = 44425,
    SPELL_MAGE_ARCANE_EXPLOSION_RANK_1 = 1449,
    SPELL_SHAMAN_CHAIN_LIGHTNING_RANK_1 = 421,
    SPELL_SHAMAN_FLAME_SHOCK_RANK_1 = 8050,
    SPELL_SHAMAN_LAVA_BURST_RANK_1 = 51505,
    SPELL_SHAMAN_VOLCANIC_ERUPTION = 770001,
    SPELL_SHAMAN_VOLCANIC_ERUPTION_MISSILE = 66682,
    SPELL_PRIEST_POWER_WORD_SHIELD_RANK_1 = 17,
    SPELL_PRIEST_PENANCE_RANK_1 = 47540,
    SPELL_PRIEST_FLASH_HEAL_RANK_1 = 2061,
    ...
    SPELL_WARRIOR_REVENGE_RANK_1 = 6572,
    SPELL_WARRIOR_REVENGE_RANK_9 = 57823,
    SPELL_WARRIOR_REND_RANK_1 = 772,
    SPELL_ROGUE_KILLING_SPREE = 51690,
    SPELL_ROGUE_KILLING_SPREE_WEAPON_DMG = 57841,
    SPELL_ROGUE_FAN_OF_KNIVES_RANK_1 = 51723,
    SPELL_ROGUE_RUPTURE_RANK_1 = 1943,
    SPELL_ROGUE_DEADLY_POISON = 25349,
    SPELL_HUNTER_VOLLEY_RANK_1 = 1510,
    SPELL_HUNTER_VOLLEY_TRIGGER_ONE = 42243,
    SPELL_HUNTER_AIMED_SHOT_RANK_1 = 19434,
    SPELL_HUNTER_SERPENT_STING_RANK_1 = 1978,
    SPELL_HUNTER_SERPENT_STING_RANK_12 = 49001,
    SPELL_WARLOCK_HAUNT_RANK_1 = 48181,
    SPELL_WARLOCK_HAUNT_RANK_3 = 59163,
    SPELL_WARLOCK_HAUNT_HEAL = 48210,
    SPELL_WARLOCK_SHADOW_BOLT_RANK_1 = 686,
    SPELL_WARLOCK_CHAOS_BOLT_RANK_1 = 50796,
    SPELL_WARLOCK_CHAOS_BOLT_RANK_4 = 59172,
    SPELL_WARLOCK_RAIN_OF_FIRE_RANK_1 = 5740,
    SPELL_WARLOCK_RAIN_OF_FIRE_TRIGGER_RANK_1 = 42223,
    SPELL_WARLOCK_CORRUPTION_RANK_1 = 172,
